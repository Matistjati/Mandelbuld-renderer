...
int main()
{
	try
	{
		...
		Shader explorationShader("resources/shaders/Rectangle.vertexshader", "resources/shaders/MandelBulb.fs");

		Shader renderShader("resources/shaders/Rectangle.vertexshader", "resources/shaders/MandelBulbRender.fs");
