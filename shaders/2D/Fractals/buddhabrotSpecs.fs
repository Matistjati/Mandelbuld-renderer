// Normal
{
	...
	<mainLoop>
		<loopSetup>[[defaultSetup, mapSetup, colorSetup], [inverseSetup, mapSetup, colorSetup], [complexSetup, mapSetup, colorSetup], [juliaSetupMouse, mapSetup, colorSetup],]</loopSetup>,
